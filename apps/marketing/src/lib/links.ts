...
const DEMO = process.env.NEXT_PUBLIC_DEMO_URL ?? 'https://bankstract.logickoder.dev/demo'
const DOCS = process.env.NEXT_PUBLIC_DOCS_URL ?? 'https://bankstract.logickoder.dev/docs'
